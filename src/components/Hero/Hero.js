...
const Hero = ({handleOrderPopup}) => {
    ...
    return (
        <div className='relative overflow-hidden min-h-[550px] sm:min-h-[650px] bg-gray-100 dark:bg-gray-900 flex justify-center items-center duration-200'>
            {/* Background pattern */}
            <div className='h-[700px] w-[700px] bg-primary/40 dark:bg-primary/20 absolute -top-1/2 right-0 rounded-3xl rotate-45 -z-9'></div>
                                ...
                                <div className='order-1 sm:order-2'>
                                    ...
                                    >
                                        <img
                                            src={data.img}
                                            alt={data.title}
                                            className='w-[300px] h-[300px] sm:h-[450px] sm:w-[450px] sm:scale-125 lg:scale-150 object-contain mx-auto'
                                        />
                                    </div>
                                </div>
                            </div>
